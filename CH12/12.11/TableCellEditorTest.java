...
public class TableCellEditorTest
{
	...
	Object[][] tableData =
	{
		new Object[]{"李清照" , 29 , "女" , new ImageIcon("icon/3.gif") , new ImageIcon("icon/3.gif") , true},
		new Object[]{"苏格拉底" , 56 , "男" , new ImageIcon("icon/1.gif") , new ImageIcon("icon/1.gif") , false},
		new Object[]{"李白" , 35 , "男" , new ImageIcon("icon/4.gif") , new ImageIcon("icon/4.gifr") , true},
		new Object[]{"弄玉" , 18 , "女" , new ImageIcon("icon/2.gif") , new ImageIcon("icon/5.gif"), true},
		new Object[]{"虎头" , 2 , "男" , new ImageIcon("icon/5.gif") , new ImageIcon("icon/5.gif") , true}
	};
	//定义一维数组作为列标题
...
class ExtendedTableModel extends DefaultTableModel
{
	...
	//重写getColumnClass方法，根据梅列的第一个值返回该列真实的数据类型
	public Class getColumnClass(int c)
	{
		return getValueAt(0 , c).getClass();
	}
}
//扩展DefaultCellEditor来实现ImageCellEditor类
