...
public class SwingComponent
{
	...
	public void init()
	{
		...
		newItem.setAccelerator(KeyStroke.getKeyStroke('N' , InputEvent.CTRL_MASK));	//1
		newItem.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
				ta.append("用户单机了“新建”菜单\n");
			}
		});
		//为file菜单添加菜单项
		file.add(newItem);
		...
		//调用该方法即可设置右键菜单，无需使用时间机制
		ta.setComponentPopupMenu(pop);	//4
		//设置关闭窗口时，退出程序
	...
	private void changeFlavor(int flavor) throws Exception
	{
		...
		SwingUtilities.updateComponentTreeUI(f.getContentPane());	//2
		//更新mb菜单条以及内部所有组件的UI
	...
	{
		//设置Swing窗口使用Java风格
		//JFrame.setDefaultLookAndFeelDecorated(true);		//3
