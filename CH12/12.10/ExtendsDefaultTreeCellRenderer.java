...
public class ExtendsDefaultTreeCellRenderer
{
	...
	//定义customerDb的一个子节点
	DefaultMutableTreeNode contact = new DefaultMutableTreeNode(new NodeData(DBObjectType.TABLE , "联系方式"));
	//定义employee的三个子节点
	...
	public void init()
	{
		...
		{
			//设置使用Windows风格外观
			UIManager.setLookAndFeel("com.sun.java.swing.plaf." + "windwos.WindowsLookAndFeel");
		}
		catch (Exception ex){}
		//更新JTree的UI外观
